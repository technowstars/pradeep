resource "aws_iam_role_policy" "backup_policy_one" {
  name = "aws_backup_policy_one"
...
resource "aws_iam_role_policy" "backup_policy_two" {
  name = "aws_backup_policy_two"
  role = aws_iam_role.role_backup_terraform.id
...
resource "aws_iam_role_policy" "backup_policy_three" {
  name = "aws_backup_policy_three"
  role = aws_iam_role.role_backup_terraform.id
